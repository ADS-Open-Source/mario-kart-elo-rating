...
public class ErrorHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(EmailConfigurationNotProvidedException.class)
    public ResponseEntity<String> handleEmailConfigurationNotProvidedException(EmailConfigurationNotProvidedException e) {
